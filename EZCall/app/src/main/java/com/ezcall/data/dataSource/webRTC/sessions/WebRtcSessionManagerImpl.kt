...
import com.ezcall.data.dataSource.webRTC.SignalingCommand
import com.ezcall.data.dataSource.webRTC.audio.AudioHandler
import com.ezcall.data.dataSource.webRTC.audio.AudioSwitchHandler
import com.ezcall.data.dataSource.webRTC.peer.StreamPeerConnection
import io.getstream.log.taggedLogger
import com.ezcall.data.dataSource.webRTC.peer.StreamPeerConnectionFactory
import com.ezcall.data.dataSource.webRTC.peer.StreamPeerType
import com.ezcall.data.dataSource.webRTC.utils.stringify
...
//TODO("SENd Offer in some place else ")
      if (offer != null) {
        sendAnswer()
      } else {
        sendOffer()
